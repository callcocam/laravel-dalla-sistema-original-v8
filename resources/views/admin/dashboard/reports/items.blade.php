<div class="d-flex flex-column flex-sm-row align-items-center mb-3">
    ...
    <div>
                                    <span class="btn btn-outline-{{ check_status($last->status,[
    'not-accepted'=>'danger',
    'open'=>'primary','transit'=>'warning','completed'=>'success']) }} btn-rounded btn-sm m-3 m-sm-0">
                                        {{ check_status_text($last->status,[
    'not-accepted'=>'Aguardando Aprovação'
,'open'=>'Aberto','transit'=>'Em transito','completed'=>'Completo']) }}</span>
