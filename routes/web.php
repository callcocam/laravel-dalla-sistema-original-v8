...
Route::group(['prefix'=>'/','middleware'=>['auth', 'status-published']],function (\Illuminate\Routing\Router $router) {
    ...
    \App\Suports\AliasRouteService::resources('metas', \App\Http\Controllers\Admin\MetaController::class,'metas');
    ...
    Route::get('produtos/produto/{product}/copy', [ProductController::class,'copy'])->name('admin.products-copy.index');
    ...
    \App\Suports\AliasRouteService::resources('categorias', \App\Http\Controllers\Admin\CategoryController::class,'categories');
