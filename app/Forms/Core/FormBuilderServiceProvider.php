...
use App\Forms\Core\Traits\ValidatesWhenResolved;
...
class FormBuilderServiceProvider extends ServiceProvider
{
    ...
    {
        $this->commands('App\Forms\Core\Console\FormMakeCommand');
        ...
        $this->app->alias('laravel-form-builder', 'App\Forms\Core\FormBuilder');
    ...
    protected function registerFormHelper()
    {
        ...
        $this->app->alias('laravel-form-helper', 'App\Forms\Core\FormHelper');
    }
