...
use App\Forms\Core\Events\AfterFieldCreation;
use App\Forms\Core\Events\AfterFormValidation;
use App\Forms\Core\Events\BeforeFormValidation;
use App\Forms\Core\Fields\FormField;
use App\Forms\Core\Filters\FilterResolver;
...
class Form
{
    ...
    public function rebuildForm()
    {
        ...
        if (get_class($this) === 'App\Forms\Core\Form') {
