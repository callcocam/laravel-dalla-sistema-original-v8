...
use App\Forms\Core\Events\AfterFormCreation;
...
class FormBuilder
{
     ...
     *
     * @param string $formClass The name of the class that inherits \App\Forms\Core\Form.
     ...
     *
     * @param \App\Forms\Core\Form $instance
     * @param array $options
     * @param array $data
     * @return \App\Forms\Core\Form
     */
